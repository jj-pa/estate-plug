...
class TenementContractDashboard extends PureComponent {
  ...
  getTenementMonthlyIncreaseData = async () => {
    try {
      const response = await axios.get('http://localhost:4500/api/multi_housing_contract_monthly_increase');
      this.setState({ // boards: 'test'
        tenementMonthlyIncreaseData: response.data
      });
    } catch (e) {
      console.log('tenement_contract_monthly_increase', e);
    }
  };

  getTenementMonthlyPriceData = async () => {
    try {
      const response = await axios.get('http://localhost:4500/api/multi_housing_contract_monthly_price');
      this.setState({ // boards: 'test'
        tenementMonthlyPriceData: response.data
      });
    } catch (e) {
      console.log('tenement_contract_monthly_price', e);
    }
  };

  getTenementYearlyIncreaseData = async () => {
    try {
      const response = await axios.get('http://localhost:4500/api/multi_housing_contract_yearly_increase');
      this.setState({ // boards: 'test'
        tenementYearlyIncreaseData: response.data
      });
    } catch (e) {
      console.log('tenement_contract_yearly_increase', e);
    }
  };

  getTenementYearlyPercentageData = async () => {
    try {
      const response = await axios.get('http://localhost:4500/api/multi_housing_contract_yearly_percentage');
      this.setState({ // boards: 'test'
        tenementYearlyPercentageData: response.data
      });
    } catch (e) {
      console.log('tenement_contract_yearly_percentage', e);
    }
  }
        ...
        <Grid container spacing={3} className={classes.root}>
          <Grid item xl={3} lg={4} md={6} xs={12}>
            <PieChart
              ...
              height={300}
              title="2015년 연립다세대 계약"
              desc="2015년 연립다세대 계약 거래 비중"
            />
          </Grid>
          <Grid item xl={3} lg={4} md={6} xs={12}>
            <PieChart
              ...
              height={300}
              title="2016년 연립다세대 계약"
              desc="2016년 연립다세대 계약 거래 비중"
            />
          </Grid>
          <Grid item xl={3} lg={4} md={6} xs={12}>
            <PieChart
              ...
              height={300}
              title="2017년 연립다세대 계약"
              desc="2017년 연립다세대 계약 거래 비중"
            />
          </Grid>
          <Grid item xl={3} lg={4} md={6} xs={12}>
            <PieChart
              ...
              height={300}
              title="2018년 연립다세대 계약"
              desc="2018년 연립다세대 계약 거래 비중"
            />
          </Grid>
          <Grid item xl={3} lg={4} md={6} xs={12}>
            <PieChart
              ...
              height={300}
              title="2019년 연립다세대 계약"
              desc="2019년 연립다세대 계약 거래 비중"
            />
          </Grid>
          <Grid item xl={3} lg={4} md={6} xs={12}>
            <SingleLineChart
              ...
              xKey="year"
              yKey="value"
              title="2015 ~ 2020년 연립다세대 계약 거래 증감율"
              desc="2015 ~ 2020년 월별 전체 연립다세대 계약 거래 증감율"
            />
          </Grid>
          <Grid item xl={3} lg={4} md={6} xs={12}>
            <SingleLineChart
              ...
              yKey="value"
              title="2015년 연립다세대 계약"
              desc="2015년 월별 전체 연립다세대 계약 거래 증감율"
            />
          </Grid>
          <Grid item xl={3} lg={4} md={6} xs={12}>
            <SingleLineChart
              ...
              yKey="value"
              title="2016년 연립다세대 계약"
              desc="2016년 월별 전체 연립다세대 계약 거래 증감율"
            />
          </Grid>
          <Grid item xl={3} lg={4} md={6} xs={12}>
            <SingleLineChart
              ...
              yKey="value"
              title="2017년 연립다세대 계약"
              desc="2017년 월별 전체 연립다세대 계약 거래 증감율"
            />
          </Grid>
          <Grid item xl={3} lg={4} md={6} xs={12}>
            <SingleLineChart
              ...
              yKey="value"
              title="2018년 연립다세대 계약"
              desc="2018년 월별 전체 연립다세대 계약 거래 증감율"
            />
          </Grid>
          <Grid item xl={3} lg={4} md={6} xs={12}>
            <SingleLineChart
              ...
              yKey="value"
              title="2019년 연립다세대 계약"
              desc="2019년 월별 전체 연립다세대 계약 거래 증감율"
            />
          </Grid>
          <Grid item xl={3} lg={4} md={6} xs={12}>
            <VerticalBarChart
              ...
              yKey="price"
              title="2015년 연립다세대 계약"
              desc="2015년 월별 전체 연립다세대 계약 거래금액"
            />
          </Grid>
          <Grid item xl={3} lg={4} md={6} xs={12}>
            <VerticalBarChart
              ...
              yKey="price"
              title="2016년 연립다세대 계약"
              desc="2016년 월별 전체 연립다세대 계약 거래금액"
            />
          </Grid>
          <Grid item xl={3} lg={4} md={6} xs={12}>
            <VerticalBarChart
              ...
              yKey="price"
              title="2017년 연립다세대 계약"
              desc="2017년 월별 전체 연립다세대 계약 거래금액"
            />
          </Grid>
          <Grid item xl={3} lg={4} md={6} xs={12}>
            <VerticalBarChart
              ...
              yKey="price"
              title="2018년 연립다세대 계약"
              desc="2018년 월별 전체 연립다세대 계약 거래금액"
            />
          </Grid>
          <Grid item xl={3} lg={4} md={6} xs={12}>
            <VerticalBarChart
              ...
              yKey="price"
              title="2019년 연립다세대 계약"
              desc="2019년 월별 전체 연립다세대 계약 거래금액"
            />
          </Grid>
        </Grid>
      </div>
...
TenementContractDashboard.propTypes = {
  classes: PropTypes.object.isRequired
};

export default withStyles(styles)(TenementContractDashboard);
